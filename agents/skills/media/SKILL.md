...
For playback control (play, pause, volume, status, player targeting), read `media-control.md`.

For YouTube operations (video search, playlists, add/remove videos), read `youtube.md`.
